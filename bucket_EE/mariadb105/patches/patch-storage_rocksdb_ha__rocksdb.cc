--- storage/rocksdb/ha_rocksdb.cc.orig	2020-11-10 13:15:02 UTC
...
@@ -5752,7 +5752,7 @@ static int rocksdb_init_func(void *const
...
+#if defined(HAVE_TIMER_DELETE) && !defined(_WIN32) && !defined(__APPLE__)
   ...
   io_watchdog->reset_timeout(rocksdb_io_write_timeout_secs);
 #endif
@@ -5859,7 +5859,7 @@ static int rocksdb_done_func(void *const
