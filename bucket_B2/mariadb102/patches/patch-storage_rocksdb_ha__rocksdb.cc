--- storage/rocksdb/ha_rocksdb.cc.orig	2020-11-09 21:59:50 UTC
...
@@ -5713,7 +5713,7 @@ static int rocksdb_init_func(void *const
...
+#if defined(HAVE_TIMER_DELETE) && !defined(_WIN32) && !defined(__APPLE__)
   ...
   io_watchdog->reset_timeout(rocksdb_io_write_timeout_secs);
 #endif
@@ -5820,7 +5820,7 @@ static int rocksdb_done_func(void *const
