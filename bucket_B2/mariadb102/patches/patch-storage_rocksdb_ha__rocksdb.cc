--- storage/rocksdb/ha_rocksdb.cc.orig	2022-02-10 18:06:20 UTC
...
@@ -5740,7 +5740,7 @@ static int rocksdb_init_func(void *const
...
+#if defined(HAVE_TIMER_DELETE) && !defined(_WIN32) && !defined(__APPLE__)
   ...
   io_watchdog->reset_timeout(rocksdb_io_write_timeout_secs);
 #endif
@@ -5847,7 +5847,7 @@ static int rocksdb_done_func(void *const
