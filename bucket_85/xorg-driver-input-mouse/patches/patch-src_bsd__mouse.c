...
@@ -75,11 +108,13 @@ static const char *FindDevice(InputInfoP
...
@@ -97,7 +132,7 @@ static const char *mouseDevs[] = {
 static int
...
+    const char *proto;
     ...
     mousehw_t hw;
     mousemode_t mode;
@@ -188,7 +244,13 @@ SetupAuto(InputInfoPtr pInfo, int *proto
     if (pInfo->fd == -1)
         return NULL;
...
@@ -207,9 +269,18 @@ SetupAuto(InputInfoPtr pInfo, int *proto
...
@@ -232,41 +303,41 @@ SetSysMouseRes(InputInfoPtr pInfo, const
...
@@ -274,17 +345,17 @@ MousedRunning(void)
 static const char *
...
+            ErrorF("Cannot stat %s (%s)\n", *pdev, strerror(errno));
             ...
             /*
@@ -293,28 +364,32 @@ FindDevice(InputInfoPtr pInfo, const cha
...
@@ -486,30 +561,78 @@ wsconsPreInit(InputInfoPtr pInfo, const
