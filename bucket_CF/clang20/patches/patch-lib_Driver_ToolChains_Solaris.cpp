--- lib/Driver/ToolChains/Solaris.cpp.orig	2025-07-08 23:06:32 UTC
+++ lib/Driver/ToolChains/Solaris.cpp
@@ -110,12 +110,17 @@ void solaris::Linker::ConstructJob(Compi
     }
   }
...
@@ -409,21 +414,7 @@ void Solaris::AddClangSystemIncludeArgs(
