--- src/lib-index/test-mail-index-transaction-update.c.orig	2024-08-13 10:37:50 UTC
...
@@ -630,7 +631,9 @@ static void test_mail_index_update_day_f
...
@@ -645,13 +648,13 @@ static void test_mail_index_update_day_f
 		i_zero(&hdr);
