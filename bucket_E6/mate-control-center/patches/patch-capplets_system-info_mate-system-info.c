--- capplets/system-info/mate-system-info.c.orig	2024-02-22 17:36:56 UTC
...
@@ -206,8 +209,12 @@ get_system_hostname (void)
...
+#ifdef HAVE_SYSTEMD
 ...
 {
@@ -258,6 +265,7 @@ get_hardware_model (void)
...
+#endif
 ...
 static char *
 get_cpu_info (void)
@@ -478,6 +486,7 @@ get_kernel_vesrion (void)
...
+#ifdef HAVE_SYSTEMD
 static struct {
     const char *id;
     const char *display;
@@ -560,6 +569,7 @@ get_system_virt (void)
...
@@ -615,7 +625,10 @@ mate_system_info_setup (MateSystemInfo *
 {
...
@@ -623,7 +636,6 @@ mate_system_info_setup (MateSystemInfo *
...
@@ -638,6 +650,7 @@ mate_system_info_setup (MateSystemInfo *
...
+#ifdef HAVE_SYSTEMD
     ...
     {
@@ -645,6 +658,7 @@ mate_system_info_setup (MateSystemInfo *
...
@@ -667,6 +681,7 @@ mate_system_info_setup (MateSystemInfo *
...
+#ifdef HAVE_SYSTEMD
     ...
     if (virt_text != NULL)
     {
@@ -674,6 +689,7 @@ mate_system_info_setup (MateSystemInfo *
...
@@ -706,7 +722,10 @@ mate_system_info_class_init (MateSystemI
...
@@ -717,7 +736,6 @@ mate_system_info_class_init (MateSystemI
