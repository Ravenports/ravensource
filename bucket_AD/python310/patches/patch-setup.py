--- setup.py.orig	2022-08-01 20:25:27 UTC
+++ setup.py
...
@@ -1105,8 +1108,6 @@ class PyBuildExt(build_ext):
...
@@ -1176,10 +1177,6 @@ class PyBuildExt(build_ext):
...
@@ -1661,7 +1658,7 @@ class PyBuildExt(build_ext):
