--- setup.py.orig	2021-10-04 17:40:46 UTC
+++ setup.py
...
@@ -1090,8 +1093,6 @@ class PyBuildExt(build_ext):
...
@@ -1161,10 +1162,6 @@ class PyBuildExt(build_ext):
...
@@ -1646,7 +1643,7 @@ class PyBuildExt(build_ext):
