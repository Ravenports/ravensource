--- uwsgiconfig.py.orig	2022-10-24 10:21:58 UTC
+++ uwsgiconfig.py
@@ -830,7 +830,7 @@ class uConf(object):
...
@@ -845,7 +845,7 @@ class uConf(object):
...
@@ -932,6 +932,8 @@ class uConf(object):
                      pass
             elif uwsgi_os == 'GNU':
...
@@ -966,7 +968,7 @@ class uConf(object):
                 if int(sun_major) >= 5:
                     if int(sun_minor) >= 10:
                         event_mode = 'port'
...
+            elif uwsgi_os in ('Darwin', 'FreeBSD', 'GNU/kFreeBSD', 'OpenBSD', 'NetBSD', 'DragonFly', 'MidnightBSD'):
                 ...
                 event_mode = 'poll'
@@ -1009,7 +1011,7 @@ class uConf(object):
                     if int(sun_minor) >= 10:
                         timer_mode = 'port'
...
@@ -1036,7 +1038,7 @@ class uConf(object):
                 if int(sun_major) >= 5:
                     if int(sun_minor) >= 10:
