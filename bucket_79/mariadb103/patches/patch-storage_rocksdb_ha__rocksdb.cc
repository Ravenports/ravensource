--- storage/rocksdb/ha_rocksdb.cc.orig	2020-01-26 18:37:29 UTC
...
@@ -5749,7 +5749,7 @@ static int rocksdb_init_func(void *const
...
+#if defined(HAVE_TIMER_DELETE) && !defined(_WIN32) && !defined(__APPLE__)
   ...
   io_watchdog->reset_timeout(rocksdb_io_write_timeout_secs);
 #endif
@@ -5856,7 +5856,7 @@ static int rocksdb_done_func(void *const
