--- conversions.c.orig	2021-07-29 12:53:58 UTC
+++ conversions.c
@@ -1299,6 +1299,7 @@ void to_zval_read_in6_pktinfo(const char
...
@@ -1306,6 +1307,15 @@ static const field_descriptor descriptor
