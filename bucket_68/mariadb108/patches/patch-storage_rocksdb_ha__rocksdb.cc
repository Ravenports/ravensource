--- storage/rocksdb/ha_rocksdb.cc.orig	2023-02-01 16:25:55 UTC
...
@@ -5787,7 +5787,7 @@ static int rocksdb_init_func(void *const
...
+#if defined(HAVE_TIMER_DELETE) && !defined(_WIN32) && !defined(__APPLE__) && !defined(__OpenBSD__)
   ...
   io_watchdog->reset_timeout(rocksdb_io_write_timeout_secs);
 #endif
@@ -5886,7 +5886,7 @@ static int rocksdb_done_func(void *const
