--- acinclude.m4.orig	2019-04-30 08:49:10 UTC
+++ acinclude.m4
@@ -970,15 +970,8 @@ dnl ------------------------------------
...
@@ -1028,12 +1021,6 @@ You either need to build $1 shared or bu
...
@@ -3025,8 +3012,7 @@ dnl in GNU Make which causes the .d file
...
+	CFLAGS="\$(CFLAGS_CLEAN)" dtrace -xnolibs -h -C -s $ac_srcdir[$]ac_provsrc -o \$[]@.bak && \$(SED) -e 's,PHP_,DTRACE_,g' \$[]@.bak > \$[]@
 ...
 EOF
@@ -3045,12 +3031,12 @@ dnl Always attempt to create both PIC an
