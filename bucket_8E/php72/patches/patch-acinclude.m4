--- acinclude.m4.orig	2019-03-05 11:06:09 UTC
+++ acinclude.m4
@@ -974,15 +974,9 @@ dnl ------------------------------------
...
@@ -1032,12 +1026,6 @@ You either need to build $1 shared or bu
...
@@ -3029,8 +3017,7 @@ dnl in GNU Make which causes the .d file
...
+	CFLAGS="\$(CFLAGS_CLEAN)" dtrace -xnolibs -h -C -s $ac_srcdir[$]ac_provsrc -o \$[]@.bak && \$(SED) -e 's,PHP_,DTRACE_,g' \$[]@.bak > \$[]@
 ...
 EOF
@@ -3049,12 +3036,12 @@ dnl Always attempt to create both PIC an
