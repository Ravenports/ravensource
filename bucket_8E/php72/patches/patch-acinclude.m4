--- acinclude.m4.orig	2017-11-28 09:22:53 UTC
+++ acinclude.m4
@@ -974,15 +974,9 @@ dnl ------------------------------------
...
@@ -2967,8 +2955,7 @@ dnl in GNU Make which causes the .d file
...
+	CFLAGS="\$(CFLAGS_CLEAN)" dtrace -xnolibs -h -C -s $ac_srcdir[$]ac_provsrc -o \$[]@.bak && \$(SED) -e 's,PHP_,DTRACE_,g' \$[]@.bak > \$[]@
 ...
 EOF
@@ -2987,12 +2974,12 @@ dnl Always attempt to create both PIC an
