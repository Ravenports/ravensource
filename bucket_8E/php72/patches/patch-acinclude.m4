--- acinclude.m4.orig	2020-05-12 07:02:26 UTC
+++ acinclude.m4
@@ -972,15 +972,8 @@ dnl ------------------------------------
...
@@ -1030,12 +1023,6 @@ You either need to build $1 shared or bu
...
@@ -3028,8 +3015,7 @@ dnl in GNU Make which causes the .d file
...
+	CFLAGS="\$(CFLAGS_CLEAN)" dtrace -xnolibs -h -C -s $ac_srcdir[$]ac_provsrc -o \$[]@.bak && \$(SED) -e 's,PHP_,DTRACE_,g' \$[]@.bak > \$[]@
 ...
 EOF
@@ -3048,12 +3034,12 @@ dnl Always attempt to create both PIC an
