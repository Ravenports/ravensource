--- taglib/mp4/mp4atom.cpp.orig	2026-07-11 07:04:26 UTC
...
@@ -95,7 +95,7 @@ MP4::Atom::Atom(File *file, int depth)
...
@@ -173,7 +173,7 @@ MP4::Atom::path(MP4::AtomList &path, con
...
@@ -193,12 +193,12 @@ bool MP4::Atom::removeChild(Atom *meta)
   return false;
 }
...
@@ -228,7 +228,7 @@ MP4::Atoms::Atoms(File *file) :
