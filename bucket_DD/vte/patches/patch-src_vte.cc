--- src/vte.cc.orig	2020-05-13 09:51:07 UTC
+++ src/vte.cc
@@ -29,6 +29,13 @@
...
+#endif
 ...
 #include <glib.h>
 #include <glib-unix.h>
@@ -3966,6 +3973,9 @@ Terminal::pty_io_read(int const fd,
...
@@ -3977,6 +3987,7 @@ Terminal::pty_io_read(int const fd,
...
+#endif
 				switch (ret){
 					case -1:
 						err = errno;
@@ -3985,6 +3996,7 @@ Terminal::pty_io_read(int const fd,
 						eos = true;
 						goto out;
 					default:
+#ifndef __sun__
...
@@ -4011,6 +4023,7 @@ Terminal::pty_io_read(int const fd,
