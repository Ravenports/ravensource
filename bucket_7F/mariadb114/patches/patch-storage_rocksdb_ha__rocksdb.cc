--- storage/rocksdb/ha_rocksdb.cc.orig	2026-01-31 10:50:14.000000000 -0000
...
@@ -5807,7 +5807,7 @@ static int rocksdb_init_func(void *const
...
+#if !defined(_WIN32) && !defined(__APPLE__) && !defined(__OpenBSD__) && !defined(__DragonFly__)
   ...
   io_watchdog->reset_timeout(rocksdb_io_write_timeout_secs);
 #endif
@@ -5909,7 +5909,7 @@ static int rocksdb_done_func(void *const
