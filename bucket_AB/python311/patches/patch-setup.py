--- setup.py.orig	2024-09-07 01:03:31 UTC
+++ setup.py
...
@@ -1078,8 +1081,6 @@ class PyBuildExt(build_ext):
...
@@ -1138,10 +1139,6 @@ class PyBuildExt(build_ext):
...
@@ -1180,7 +1177,12 @@ class PyBuildExt(build_ext):
