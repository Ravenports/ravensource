--- conversions.c.orig	2021-06-29 09:30:32 UTC
+++ conversions.c
@@ -1304,6 +1304,7 @@ void to_zval_read_in6_pktinfo(const char
...
@@ -1311,6 +1312,15 @@ static const field_descriptor descriptor
