--- acinclude.m4.orig	2020-06-09 08:06:39 UTC
+++ acinclude.m4
@@ -969,15 +969,8 @@ dnl ------------------------------------
...
@@ -3003,8 +2990,7 @@ dnl in GNU Make which causes the .d file
...
+	CFLAGS="\$(CFLAGS_CLEAN)" dtrace -xnolibs -h -C -s $ac_srcdir[$]ac_provsrc -o \$[]@.bak && \$(SED) -e 's,PHP_,DTRACE_,g' \$[]@.bak > \$[]@
 ...
 EOF
@@ -3023,12 +3009,12 @@ dnl Always attempt to create both PIC an
