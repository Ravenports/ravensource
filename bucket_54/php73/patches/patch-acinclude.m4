--- acinclude.m4.orig	2020-10-27 11:02:08 UTC
+++ acinclude.m4
@@ -969,15 +969,8 @@ dnl ------------------------------------
...
@@ -3005,8 +2992,7 @@ dnl in GNU Make which causes the .d file
...
+	CFLAGS="\$(CFLAGS_CLEAN)" dtrace -xnolibs -h -C -s $ac_srcdir[$]ac_provsrc -o \$[]@.bak && \$(SED) -e 's,PHP_,DTRACE_,g' \$[]@.bak > \$[]@
 ...
 EOF
@@ -3025,12 +3011,12 @@ dnl Always attempt to create both PIC an
