--- acinclude.m4.orig	2019-03-05 13:50:48 UTC
+++ acinclude.m4
@@ -971,15 +971,9 @@ dnl ------------------------------------
...
@@ -3004,8 +2992,7 @@ dnl in GNU Make which causes the .d file
...
+	CFLAGS="\$(CFLAGS_CLEAN)" dtrace -xnolibs -h -C -s $ac_srcdir[$]ac_provsrc -o \$[]@.bak && \$(SED) -e 's,PHP_,DTRACE_,g' \$[]@.bak > \$[]@
 ...
 EOF
@@ -3024,12 +3011,12 @@ dnl Always attempt to create both PIC an
