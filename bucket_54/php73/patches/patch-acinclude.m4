--- acinclude.m4.orig	2021-04-27 13:57:17 UTC
+++ acinclude.m4
@@ -969,15 +969,8 @@ dnl ------------------------------------
...
@@ -1027,12 +1020,6 @@ You either need to build $1 shared or bu
...
@@ -3007,8 +2994,7 @@ dnl in GNU Make which causes the .d file
...
+	CFLAGS="\$(CFLAGS_CLEAN)" dtrace -xnolibs -h -C -s $ac_srcdir[$]ac_provsrc -o \$[]@.bak && \$(SED) -e 's,PHP_,DTRACE_,g' \$[]@.bak > \$[]@
 ...
 EOF
@@ -3027,12 +3013,12 @@ dnl Always attempt to create both PIC an
