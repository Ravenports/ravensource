--- acinclude.m4.orig	2019-04-30 08:37:26 UTC
+++ acinclude.m4
@@ -967,15 +967,8 @@ dnl ------------------------------------
...
@@ -1025,12 +1018,6 @@ You either need to build $1 shared or bu
...
@@ -3000,8 +2987,7 @@ dnl in GNU Make which causes the .d file
...
+	CFLAGS="\$(CFLAGS_CLEAN)" dtrace -xnolibs -h -C -s $ac_srcdir[$]ac_provsrc -o \$[]@.bak && \$(SED) -e 's,PHP_,DTRACE_,g' \$[]@.bak > \$[]@
 ...
 EOF
@@ -3020,12 +3006,12 @@ dnl Always attempt to create both PIC an
