...
+++ src/sort_r.h
@@ -24,12 +24,15 @@ void sort_r(void *base, size_t nel, size
...
+#  define _SORT_R_SUN
 ...
 #else
@@ -65,7 +68,7 @@ void sort_r(void *base, size_t nel, size
...
+    extern void (qsort_r)(void *base, size_t nel, size_t width, void *thunk,
     ...
     struct sort_r_data
@@ -83,10 +86,15 @@ void sort_r(void *base, size_t nel, size
...
+
   ...
   /* implementation */
@@ -106,6 +114,10 @@ void sort_r(void *base, size_t nel, size
       tmp.compar = compar;
...
@@ -121,5 +133,6 @@ void sort_r(void *base, size_t nel, size
