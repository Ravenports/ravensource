...
--- src/main/character.c.orig	2024-04-02 22:15:01 UTC
+++ src/main/character.c
@@ -1750,7 +1750,7 @@ attribute_hidden SEXP do_strtrim(SEXP ca
     return s;
 }
...
@@ -1783,7 +1783,7 @@ attribute_hidden SEXP do_strtoi(SEXP cal
