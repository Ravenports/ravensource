--- common/putil.cpp.orig	2019-10-03 11:16:41 UTC
+++ common/putil.cpp
@@ -1931,7 +1931,7 @@ remapPlatformDependentCodepage(const cha
          */
         name = "ISO-8859-1";
     }
...
@@ -1950,11 +1950,6 @@ remapPlatformDependentCodepage(const cha
          */
         name = "UTF-8";
     }
