--- common/putil.cpp.orig	2020-04-22 20:04:20 UTC
+++ common/putil.cpp
@@ -1943,7 +1943,7 @@ remapPlatformDependentCodepage(const cha
          */
         name = "ISO-8859-1";
     }
...
@@ -1962,11 +1962,6 @@ remapPlatformDependentCodepage(const cha
          */
         name = "UTF-8";
     }
